...
<main id="top">
    ...
    <div class="page-container">
        <section class="vision">
            ...
            <p class="font-20 font-weight-normal">テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト</p>
            <p class="font-20 font-weight-normal">テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト</p>
            <div class="container">
                <div class="row mt-4 mt-md-5 py-4">
                    ...
                    <div class="col-md-7 pt-2">
                        ...
                        <p class="font-20">テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト</p>
                        <div class="red-btn mt-4">
                            <a href="<?php echo get_site_url();?>/ja/about-jp#vision" class="d-flex align-items-center justify-content-between">
                ...
                <div class="row mt-4 mt-md-5 pt-4">
                    <div class="col-md-7 pt-2">
                        ...
                        <p class="font-20 ">テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト</p>
                        <div class="red-btn mt-4">
                            <a href="<?php echo get_site_url();?>/ja/about-jp#values" class="d-flex align-items-center justify-content-between">
                                <div class="font-16 font-weight-bold">View more</div>
                                <span class="font-20 font-weight-bold">&#62;</span>
                            </a>
                        </div>
        ...
        <section class="service">
            ...
            <div class="section-content mt-5 position-relative">
                ...
                <div class="view-btn position-absolute">
                    <a href="<?php echo get_site_url();?>/ja/service-jp" class="d-flex align-items-center justify-content-between">
                        <div class="font-16 font-weight-bold">View more</div>
                        <span class="font-20 font-weight-bold">&#62;</span>
                    </a>
                </div>
        ...
        <section class="message">
            ...
            <div class="section-content mt-5 position-relative">
                ...
                <div class="view-btn position-absolute">
                    <a href="<?php echo get_site_url();?>/ja/message-jp" class="d-flex align-items-center justify-content-between">
                        <div class="font-16 font-weight-bold">View more</div>
                        <span class="font-20 font-weight-bold">&#62;</span>
                    </a>
                </div>
        ...
        <section class="careers">
            ...
            <div class="section-content mt-5 position-relative">
                ...
                <div class="view-btn position-absolute">
                    <a href="<?php echo get_site_url();?>/ja/careers" class="d-flex align-items-center justify-content-between">
                        <div class="font-16 font-weight-bold">View more</div>
                        <span class="font-20 font-weight-bold">&#62;</span>
                    </a>
                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="section-content mt-5 position-relative">
                        ...
                        <div class="view-btn">
                            <a href="<?php echo get_site_url();?>/ja/about-jp#members" class="d-flex align-items-center justify-content-between">
                                <div class="font-16 font-weight-bold">View more</div>
                                <span class="font-20 font-weight-bold">&#62;</span>
                            </a>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="section-content mt-5 position-relative">
                        ...
                        <div class="view-btn">
                            <a href="<?php echo get_site_url();?>/ja/about-jp#access" class="d-flex align-items-center justify-content-between">
                                <div class="font-16 font-weight-bold">View more</div>
                                <span class="font-20 font-weight-bold">&#62;</span>
                            </a>
                        </div>
        ...
        <section class="news">
            ...
            <div class="red-btn mt-4">
                <a href="<?php echo esc_url( home_url( '/ja/news' ) ); ?>" class="ml-auto d-flex align-items-center justify-content-between">
                    <div class="font-16 font-weight-bold">View more</div>
                    <span class="font-20 font-weight-bold">&#62;</span>
                </a>
            </div>
